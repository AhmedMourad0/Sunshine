package com.example.ahmed.sunshine.sync;
...
import com.example.ahmed.sunshine.BuildConfig;
import com.example.ahmed.sunshine.MainActivity;
import com.example.ahmed.sunshine.R;
import com.example.ahmed.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static Account getSyncAccount(Context context) {
        ...
        if (accountManager != null && accountManager.getPassword(newAccount) == null) {
...
//            final String QUERY_PARAM = "id";
    ...
    public static void notifyWeather(Context context) {
        ...
        boolean displayNotifications = PreferenceManager
            ...
            if (cursor != null) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                            .setColor(ContextCompat.getColor(context, R.color.sunshine_light_blue))
                            .setSmallIcon(iconId)
